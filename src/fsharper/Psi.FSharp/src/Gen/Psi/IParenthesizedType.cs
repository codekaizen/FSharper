...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IParenthesizedType : JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.Tree.IParenthesizedTypeNode ToTreeNode();
  }
}

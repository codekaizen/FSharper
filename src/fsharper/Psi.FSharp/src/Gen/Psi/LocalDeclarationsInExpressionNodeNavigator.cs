...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class LocalDeclarationsInExpressionNodeNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.Tree.ILocalDeclarationsInExpressionNode GetByBindingsNode (JetBrains.ReSharper.Psi.FSharp.Tree.IBindingNode param) {
    ...
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.Tree.ILocalDeclarationsInExpressionNode GetByExpressionNode (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param) {
      if (param == null) return null;
      TreeElement current = (TreeElement)param;
      if (current.parent is JetBrains.ReSharper.Psi.FSharp.Impl.Tree.LocalDeclarationsInExpressionStub) {

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class RecordPatternNodeNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IRecordPatternNode GetByFieldPatternList (JetBrains.ReSharper.Psi.FSharp.IFieldPatternListNode param) {

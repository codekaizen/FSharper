...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class LetDefinitionNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.Tree.ILetDefinitionNode GetByBindingScheme (JetBrains.ReSharper.Psi.FSharp.IBindingScheme param) {

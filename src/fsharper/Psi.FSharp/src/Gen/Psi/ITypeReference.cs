...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface ITypeReference : JetBrains.ReSharper.Psi.FSharp.Tree.IFSharpElement {
    ...
    new JetBrains.ReSharper.Psi.FSharp.Tree.ITypeReferenceNode ToTreeNode();
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal abstract partial class WithoutParameterTypeReferenceStub : JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpCompositeElement, JetBrains.ReSharper.Psi.FSharp.Tree.IWithoutParameterTypeReferenceNode, JetBrains.ReSharper.Psi.FSharp.Tree.IWithoutParameterTypeReference {
    public const short TYPE_REFERENCE= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public WithoutParameterTypeReferenceStub() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.WITHOUT_PARAMETER_TYPE_REFERENCE; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitWithoutParameterTypeReference(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitWithoutParameterTypeReferenceNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.Tree.IWithoutParameterTypeReferenceNode JetBrains.ReSharper.Psi.FSharp.Tree.IWithoutParameterTypeReference.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IWithoutParameterTypeReference";
    }
  }
}

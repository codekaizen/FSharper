...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ParenthesizedFieldValueExpression : OperatorExpressionBase, JetBrains.ReSharper.Psi.FSharp.IParenthesizedFieldValueExpressionNode, JetBrains.ReSharper.Psi.FSharp.IParenthesizedFieldValueExpression {
    ...
    internal ParenthesizedFieldValueExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.PARENTHESIZED_FIELD_VALUE_EXPRESSION; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitParenthesizedFieldValueExpression(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitParenthesizedFieldValueExpressionNode(this, context);
    }
    ...
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      ...
      if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_LPARENTH_OP) {
        if (current == child) return FSHARP_LPARENTH;
        current = GetNextFilteredChild(current);
        if (current == null) return 0;
      } else return 0;
      if (TokenBitsets.ElementBitset_0[current.NodeType]) {
      ...
      if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_RPARENTH_OP) {
        if (current == child) return FSHARP_RPARENTH;
        current = GetNextFilteredChild(current);
        if (current == null) return 0;
      } else return 0;
      return 0;
    ...
    JetBrains.ReSharper.Psi.FSharp.IParenthesizedFieldValueExpressionNode JetBrains.ReSharper.Psi.FSharp.IParenthesizedFieldValueExpression.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IParenthesizedFieldValueExpression";
    }
  }
}

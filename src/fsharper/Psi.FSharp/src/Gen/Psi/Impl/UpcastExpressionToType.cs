...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class UpcastExpressionToType : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.IUpcastExpressionToTypeNode, JetBrains.ReSharper.Psi.FSharp.IUpcastExpressionToType {
    ...
    public const short FSHARP_COLONGT= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.FSHARP_COLONGT;
    ...
    internal UpcastExpressionToType() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.UPCAST_EXPRESSION_TO_TYPE; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitUpcastExpressionToType(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitUpcastExpressionToTypeNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        ...
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_COLONGT_OP, FSHARP_COLONGT),
      }
    );
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      return CHILD_ROLES[child.NodeType];
    }
    public virtual JetBrains.ReSharper.Psi.ITokenNode ColonGT {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(FSHARP_COLONGT); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression SetType (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_COLONGT_OP) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression)result;
          }
    ...
    JetBrains.ReSharper.Psi.FSharp.IUpcastExpressionToTypeNode JetBrains.ReSharper.Psi.FSharp.IUpcastExpressionToType.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IUpcastExpressionToType";
    }
  }
}

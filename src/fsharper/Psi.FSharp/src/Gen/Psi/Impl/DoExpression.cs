...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class DoExpression : JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpCompositeElement, JetBrains.ReSharper.Psi.FSharp.IDoExpressionNode, JetBrains.ReSharper.Psi.FSharp.IDoExpression {
    ...
    internal DoExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.DO_EXPRESSION; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitDoExpressionNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.IDoExpressionNode JetBrains.ReSharper.Psi.FSharp.IDoExpression.ToTreeNode() { return this; }

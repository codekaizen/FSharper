...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class TypedExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.ITypedExpressionNode, JetBrains.ReSharper.Psi.FSharp.ITypedExpression {
    ...
    internal TypedExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.TYPED_EXPRESSION; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitTypedExpression(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitTypedExpressionNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.ITypedExpressionNode JetBrains.ReSharper.Psi.FSharp.ITypedExpression.ToTreeNode() { return this; }

...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class LazyExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.ILazyExpressionNode, JetBrains.ReSharper.Psi.FSharp.ILazyExpression {
    public const short LAZY_KEYWORD= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public const short EXPRESSION= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 2;
    internal LazyExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.LAZY_EXPRESSION; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitLazyExpressionNode(this, context);
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression SetExpression (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_LAZY) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          }
    ...
    JetBrains.ReSharper.Psi.FSharp.ILazyExpressionNode JetBrains.ReSharper.Psi.FSharp.ILazyExpression.ToTreeNode() { return this; }

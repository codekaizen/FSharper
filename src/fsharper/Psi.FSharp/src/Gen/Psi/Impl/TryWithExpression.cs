...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class TryWithExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.ITryWithExpressionNode, JetBrains.ReSharper.Psi.FSharp.ITryWithExpression {
    ...
    public const short FSHARP_WITH= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.FSHARP_WITH;
    public const short PATTERN_MATCHING= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 4;
    internal TryWithExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.TRY_WITH_EXPRESSION; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitTryWithExpression(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitTryWithExpressionNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_WITH, FSHARP_WITH),
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.PATTERN_MATCHING, PATTERN_MATCHING),
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.IPatternMatching PatternMatching {
      get { return (JetBrains.ReSharper.Psi.FSharp.IPatternMatching) FindChildByRole(PATTERN_MATCHING); }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.IPatternMatchingNode PatternMatchingNode {
      get { return (JetBrains.ReSharper.Psi.FSharp.IPatternMatchingNode) FindChildByRole(PATTERN_MATCHING); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.ITokenNode WithKeyword {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(FSHARP_WITH); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.IPatternMatching SetPatternMatching (JetBrains.ReSharper.Psi.FSharp.IPatternMatching param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.IPatternMatchingNode SetPatternMatchingNode (JetBrains.ReSharper.Psi.FSharp.IPatternMatchingNode param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
    ...
    JetBrains.ReSharper.Psi.FSharp.ITryWithExpressionNode JetBrains.ReSharper.Psi.FSharp.ITryWithExpression.ToTreeNode() { return this; }

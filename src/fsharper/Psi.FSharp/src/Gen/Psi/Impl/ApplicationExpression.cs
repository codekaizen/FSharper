...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ApplicationExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.IApplicationExpressionNode, JetBrains.ReSharper.Psi.FSharp.IApplicationExpression {
    public const short EXPRESSION= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public const short OPERAND= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 2;
    internal ApplicationExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.APPLICATION_EXPRESSION; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitApplicationExpressionNode(this, context);
    }
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      ...
      if (TokenBitsets.ElementBitset_0[current.NodeType]) {
        if (current == child) return OPERAND;
        current = GetNextFilteredChild(current);
        if (current == null) return 0;
      } else return 0;
      return 0;
    ...
    JetBrains.ReSharper.Psi.FSharp.IApplicationExpressionNode JetBrains.ReSharper.Psi.FSharp.IApplicationExpression.ToTreeNode() { return this; }

...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ListConstructorExpression : OperatorExpressionBase, JetBrains.ReSharper.Psi.FSharp.IListConstructorExpressionNode, JetBrains.ReSharper.Psi.FSharp.IListConstructorExpression {
    ...
    internal ListConstructorExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.LIST_CONSTRUCTOR_EXPRESSION; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitListConstructorExpressionNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_COLONCOLON_OP, OPERATION_SIGN),
      }
    );
    ...
    JetBrains.ReSharper.Psi.FSharp.IListConstructorExpressionNode JetBrains.ReSharper.Psi.FSharp.IListConstructorExpression.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IListConstructorExpression";
    }
  }
}

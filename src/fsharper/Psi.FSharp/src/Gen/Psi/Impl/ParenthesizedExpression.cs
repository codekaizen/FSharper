...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ParenthesizedExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.IParenthesizedExpressionNode, JetBrains.ReSharper.Psi.FSharp.IParenthesizedExpression {
    ...
    internal ParenthesizedExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.PARENTHESIZED_EXPRESSION; }
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitParenthesizedExpressionNode(this, context);
    }
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitParenthesizedExpressionNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.IParenthesizedExpressionNode JetBrains.ReSharper.Psi.FSharp.IParenthesizedExpression.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IParenthesizedExpression";
    }
  }
}

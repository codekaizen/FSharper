...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class TupleExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.ITupleExpressionNode, JetBrains.ReSharper.Psi.FSharp.ITupleExpression {
    public const short EXPRESSION= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public const short FSHARP_COMMA= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.FSHARP_COMMA;
    internal TupleExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.TUPLE_EXPRESSION; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitTupleExpressionNode(this, context);
    }
    ...
    public JetBrains.ReSharper.Psi.Tree.TreeNodeCollection<JetBrains.ReSharper.Psi.FSharp.Tree.IExpression> Expression {
      get { return FindListOfChildrenByRole<JetBrains.ReSharper.Psi.FSharp.Tree.IExpression>(EXPRESSION); }
    }
    public JetBrains.ReSharper.Psi.Tree.TreeNodeCollection<JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode> ExpressionNode {
      get { return FindListOfChildrenByRole<JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode>(EXPRESSION); }
    }
    /*
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression AddExpressionBefore (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param, JetBrains.ReSharper.Psi.FSharp.Tree.IExpression anchor)
    {
      throw new NotImplementedException ("AddExpressionBefore");
    ...
    */
    /*
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode AddExpressionNodeBefore (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param, JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode anchor)
    {
      throw new NotImplementedException ("AddExpressionNodeBefore");
      using (Shell.WriteLockCookie.Create ())
      {
        TreeElement current = null, next, result = null;
        TreeElement childToAddBefore = null;
    ...
    */
    /*
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression AddExpressionAfter (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param, JetBrains.ReSharper.Psi.FSharp.Tree.IExpression anchor)
    {
      throw new NotImplementedException ("AddExpressionAfter");
      using (Shell.WriteLockCookie.Create ())
      {
        TreeElement current = null, next, result = null;
    ...
    */
    /*
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode AddExpressionNodeAfter (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param, JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode anchor)
    {
      throw new NotImplementedException ("AddExpressionNodeAfter");
      using (Shell.WriteLockCookie.Create ())
      {
        TreeElement current = null, next, result = null;
        TreeElement childToAddAfter = null;
    ...
    */
    /*
    public virtual void RemoveExpression (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param)
    {
      throw new NotImplementedException ("RemoveExpression");
    }
    */
    /*
    public virtual void RemoveExpressionNode (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param)
    {
      throw new NotImplementedException ("RemoveExpressionNode");
    }
    */
    JetBrains.ReSharper.Psi.FSharp.ITupleExpressionNode JetBrains.ReSharper.Psi.FSharp.ITupleExpression.ToTreeNode() { return this; }

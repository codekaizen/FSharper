...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class BinaryPowerExpression : OperatorExpressionBase, JetBrains.ReSharper.Psi.FSharp.IBinaryPowerExpressionNode, JetBrains.ReSharper.Psi.FSharp.IBinaryPowerExpression {
    ...
    internal BinaryPowerExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.BINARY_POWER_EXPRESSION; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitBinaryPowerExpression(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitBinaryPowerExpressionNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_ASTERISKASTERISK, OPERATION_SIGN),
      }
    );
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      ...
      if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_ASTERISKASTERISK) {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression SetRightOperand (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_ASTERISKASTERISK) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          }
    ...
    JetBrains.ReSharper.Psi.FSharp.IBinaryPowerExpressionNode JetBrains.ReSharper.Psi.FSharp.IBinaryPowerExpression.ToTreeNode() { return this; }

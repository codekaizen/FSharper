...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ArrayPattern : PatternBase, JetBrains.ReSharper.Psi.FSharp.IArrayPatternNode, JetBrains.ReSharper.Psi.FSharp.IArrayPattern {
    ...
    public const short FSAHRP_RBRACKET= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 4;
    internal ArrayPattern() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.ARRAY_PATTERN; }
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitArrayPatternNode(this, context);
    }
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitArrayPatternNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_ORRBRACKET_OP, FSAHRP_RBRACKET),
        ...
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_LBRACKETOR_OP, FSAHRP_LBRACKET),
      }
    );
    ...
    public virtual JetBrains.ReSharper.Psi.ITokenNode LBracket {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(FSAHRP_LBRACKET); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.ITokenNode RBracket {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(FSAHRP_RBRACKET); }
    }
    ...
    */
    JetBrains.ReSharper.Psi.FSharp.IArrayPatternNode JetBrains.ReSharper.Psi.FSharp.IArrayPattern.ToTreeNode() { return this; }

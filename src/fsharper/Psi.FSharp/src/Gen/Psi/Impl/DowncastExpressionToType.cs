...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class DowncastExpressionToType : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.IDowncastExpressionToTypeNode, JetBrains.ReSharper.Psi.FSharp.IDowncastExpressionToType {
    ...
    public const short FSHARP_COLONQUESTGT= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.FSHARP_COLONQUESTGT;
    public const short TYPE= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 4;
    public const short FSHARP_RPARENTH= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.FSHARP_RPARENTH;
    internal DowncastExpressionToType() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.DOWNCAST_EXPRESSION_TO_TYPE; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitDowncastExpressionToType(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitDowncastExpressionToTypeNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        ...
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_COLONQUESTGT_OP, FSHARP_COLONQUESTGT),
      }
    );
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      return CHILD_ROLES[child.NodeType];
    }
    public virtual JetBrains.ReSharper.Psi.ITokenNode ColonQuestGT {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(FSHARP_COLONQUESTGT); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression Type {
      get { return (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression) FindChildByRole(TYPE); }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode TypeNode {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression SetType (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_COLONQUESTGT_OP) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression)result;
          }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode SetTypeNode (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
    ...
    JetBrains.ReSharper.Psi.FSharp.IDowncastExpressionToTypeNode JetBrains.ReSharper.Psi.FSharp.IDowncastExpressionToType.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IDowncastExpressionToType";
    }
  }
}

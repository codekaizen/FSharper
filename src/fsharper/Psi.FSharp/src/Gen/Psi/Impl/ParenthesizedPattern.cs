...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ParenthesizedPattern : PatternBase, JetBrains.ReSharper.Psi.FSharp.IParenthesizedPatternNode, JetBrains.ReSharper.Psi.FSharp.IParenthesizedPattern {
    ...
    internal ParenthesizedPattern() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.PARENTHESIZED_PATTERN; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitParenthesizedPatternNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.IParenthesizedPatternNode JetBrains.ReSharper.Psi.FSharp.IParenthesizedPattern.ToTreeNode() { return this; }

...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal abstract partial class TypeReferenceStub : TypeExpressionBase, JetBrains.ReSharper.Psi.FSharp.Tree.ITypeReferenceNode, JetBrains.ReSharper.Psi.FSharp.Tree.ITypeReference {
    ...
    public TypeReferenceStub() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.TYPE_REFERENCE; }
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitTypeReferenceNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.Tree.ITypeReferenceNode JetBrains.ReSharper.Psi.FSharp.Tree.ITypeReference.ToTreeNode() { return this; }

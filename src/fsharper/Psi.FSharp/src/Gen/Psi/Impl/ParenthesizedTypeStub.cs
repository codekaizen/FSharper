...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal abstract partial class ParenthesizedTypeStub : TypeExpressionBase, JetBrains.ReSharper.Psi.FSharp.Tree.IParenthesizedTypeNode, JetBrains.ReSharper.Psi.FSharp.Tree.IParenthesizedType {
    ...
    public ParenthesizedTypeStub() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.PARENTHESIZED_TYPE; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.ElementVisitor<TContext,TReturn> visitor, TContext context) {
      return visitor.VisitParenthesizedType(this, context);
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitParenthesizedTypeNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.Tree.IParenthesizedTypeNode JetBrains.ReSharper.Psi.FSharp.Tree.IParenthesizedType.ToTreeNode() { return this; }

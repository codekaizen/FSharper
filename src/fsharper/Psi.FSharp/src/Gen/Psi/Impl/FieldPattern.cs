...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class FieldPattern : JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpCompositeElement, JetBrains.ReSharper.Psi.FSharp.IFieldPatternNode, JetBrains.ReSharper.Psi.FSharp.IFieldPattern {
    ...
    public const short PATTERN= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 3;
    internal FieldPattern() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.FIELD_PATTERN; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.ElementVisitor<TContext,TReturn> visitor, TContext context) {
      return visitor.VisitFieldPattern(this, context);
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitFieldPatternNode(this, context);
    }
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitFieldPatternNode(this, context);
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReference FieldName {
      get { return (JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReference) FindChildByRole(FIELD); }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReferenceNode FieldNameNode {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReference SetFieldName (JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReference param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        return (JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReference)result;
      }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReferenceNode SetFieldNameNode (JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReferenceNode param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
    ...
    JetBrains.ReSharper.Psi.FSharp.IFieldPatternNode JetBrains.ReSharper.Psi.FSharp.IFieldPattern.ToTreeNode() { return this; }
    public override string ToString() {
      return "IFieldPattern";
    }
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class InfixOperatorExpression : OperatorExpressionBase, JetBrains.ReSharper.Psi.FSharp.IInfixOperatorExpressionNode, JetBrains.ReSharper.Psi.FSharp.IInfixOperatorExpression {
    ...
    public const short RIGHT_OPERAND= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 5;
    internal InfixOperatorExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.INFIX_OPERATOR_EXPRESSION; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitInfixOperatorExpression(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitInfixOperatorExpressionNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_OR, OPERATION_SIGN),
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_AND, OPERATION_SIGN),
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_DOLLAR, OPERATION_SIGN),
      }
    );
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      ...
      if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_OR) {
        if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_OR) {
      ...
      else if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_AND) {
        if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_AND) {
          if (current == child) return OPERATION_SIGN;
          current = GetNextFilteredChild(current);
          if (current == null) return 0;
        } else return 0;
      }
      else if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_DOLLAR) {
        if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_DOLLAR) {
          if (current == child) return OPERATION_SIGN;
          current = GetNextFilteredChild(current);
          if (current == null) return 0;
        } else return 0;
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression SetRightOperand (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        next = GetNextFilteredChild (current);
        if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_OR) {
          next = GetNextFilteredChild (current);
          if (next == null) {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          } else {
        ...
        else if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_AND) {
          next = GetNextFilteredChild (current);
          if (next == null) {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          } else {
            if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_AND) {
              current = next;
            } else {
              return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
            }
        ...
        else if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_DOLLAR) {
          next = GetNextFilteredChild (current);
          if (next == null) {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          } else {
            if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.OPERATOR_DOLLAR) {
              current = next;
            } else {
              return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
            }
    ...
    JetBrains.ReSharper.Psi.FSharp.IInfixOperatorExpressionNode JetBrains.ReSharper.Psi.FSharp.IInfixOperatorExpression.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IInfixOperatorExpression";
    }
  }
}

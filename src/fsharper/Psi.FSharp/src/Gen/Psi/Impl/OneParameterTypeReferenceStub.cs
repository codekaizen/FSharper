...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal abstract partial class OneParameterTypeReferenceStub : JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpCompositeElement, JetBrains.ReSharper.Psi.FSharp.Tree.IOneParameterTypeReferenceNode, JetBrains.ReSharper.Psi.FSharp.Tree.IOneParameterTypeReference {
    public const short PARAMETER= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public const short TYPE_REFERENCE= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 2;
    public OneParameterTypeReferenceStub() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.ONE_PARAMETER_TYPE_REFERENCE; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitOneParameterTypeReference(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitOneParameterTypeReferenceNode(this, context);
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression Parameter {
      get { return (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression) FindChildByRole(PARAMETER); }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode ParameterNode {
      get { return (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode) FindChildByRole(PARAMETER); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression SetParameter (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression param)
    {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode SetParameterNode (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpressionNode param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
    ...
    JetBrains.ReSharper.Psi.FSharp.Tree.IOneParameterTypeReferenceNode JetBrains.ReSharper.Psi.FSharp.Tree.IOneParameterTypeReference.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IOneParameterTypeReference";
    }
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal abstract partial class ExceptionAliasStub : JetBrains.ReSharper.Psi.FSharp.Impl.InferenceCacheSupport.InferenceTypeBase, JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionAliasNode, JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionAlias {
    public const short EXCEPTION_KEYWORD= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public const short EXCEPTION_NAME= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 2;
    public const short OF_KEYWORD= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 3;
    ...
    public const short ALIAS= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 6;
    public ExceptionAliasStub() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.EXCEPTION_ALIAS; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitExceptionAlias(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitExceptionAliasNode(this, context);
    }
    private static readonly JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short> CHILD_ROLES = new JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeTypeDictionary<short>(
      new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>[]
      {
        ...
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_OF, OF_KEYWORD),
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.EXCEPTION_REFERENCE, ALIAS),
        ...
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_EXCEPTION, EXCEPTION_KEYWORD),
        new System.Collections.Generic.KeyValuePair<JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType, short>(JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType._IDENTIFIER, EXCEPTION_NAME),
      }
    );
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      return CHILD_ROLES[child.NodeType];
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference AliasReference {
      get { return (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference) FindChildByRole(ALIAS); }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode AliasReferenceNode {
      get { return (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode) FindChildByRole(ALIAS); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.ITokenNode ExceptionKeyword {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(EXCEPTION_KEYWORD); }
    }
    public virtual JetBrains.ReSharper.Psi.FSharp.IIdentifierNode ExceptionName {
      get { return (JetBrains.ReSharper.Psi.FSharp.IIdentifierNode) FindChildByRole(EXCEPTION_NAME); }
    }
    public virtual JetBrains.ReSharper.Psi.ITokenNode OFKeyword {
      get { return (JetBrains.ReSharper.Psi.ITokenNode) FindChildByRole(OF_KEYWORD); }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference SetAliasReference (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        if (next == null) {
          return (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference)result;
        } else {
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_EXCEPTION) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference)result;
          }
        ...
        next = GetNextFilteredChild (current);
        if (next != null && (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_OF)) {
          next = GetNextFilteredChild (current);
          if (next == null) {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReference)result;
          } else {
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.EXCEPTION_REFERENCE) {
            if (param != null) {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode SetAliasReferenceNode (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
        next = GetNextFilteredChild (current);
        if (next == null) {
          return (JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode)result;
        } else {
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_EXCEPTION) {
            current = next;
          } else {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.IIdentifierNode SetExceptionName (JetBrains.ReSharper.Psi.FSharp.IIdentifierNode param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        TreeElement current = null, next = GetNextFilteredChild (current), result = null;
    ...
    JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionAliasNode JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionAlias.ToTreeNode() { return this; }
    JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionDefinitionNode JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionDefinition.ToTreeNode() { return this; }

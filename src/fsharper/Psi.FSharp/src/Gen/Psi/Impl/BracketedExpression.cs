...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class BracketedExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.IBracketedExpressionNode, JetBrains.ReSharper.Psi.FSharp.IBracketedExpression {
    ...
    internal BracketedExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.BRACKETED_EXPRESSION; }
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitBracketedExpressionNode(this, context);
    }
    ...
    JetBrains.ReSharper.Psi.FSharp.IBracketedExpressionNode JetBrains.ReSharper.Psi.FSharp.IBracketedExpression.ToTreeNode() { return this; }

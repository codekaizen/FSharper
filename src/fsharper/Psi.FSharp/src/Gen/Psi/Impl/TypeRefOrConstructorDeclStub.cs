...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal abstract partial class TypeRefOrConstructorDeclStub : JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpCompositeElement, JetBrains.ReSharper.Psi.FSharp.Tree.ITypeRefOrConstructorDeclNode, JetBrains.ReSharper.Psi.FSharp.Tree.ITypeRefOrConstructorDecl {
    public const short NAME= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 1;
    public TypeRefOrConstructorDeclStub() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.TYPE_REF_OR_CONSTRUCTOR_DECL; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitTypeRefOrConstructorDecl(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitTypeRefOrConstructorDeclNode(this, context);
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.IIdentifierNode Name {
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.IIdentifierNode SetName (JetBrains.ReSharper.Psi.FSharp.IIdentifierNode param)
    {
    ...
    JetBrains.ReSharper.Psi.FSharp.Tree.ITypeRefOrConstructorDeclNode JetBrains.ReSharper.Psi.FSharp.Tree.ITypeRefOrConstructorDecl.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "ITypeRefOrConstructorDecl";
    }
  }
}

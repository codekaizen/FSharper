...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class BracketedFieldValueExpression : OperatorExpressionBase, JetBrains.ReSharper.Psi.FSharp.IBracketedFieldValueExpressionNode, JetBrains.ReSharper.Psi.FSharp.IBracketedFieldValueExpression {
    ...
    public const short RIGHT_OPERAND= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 4;
    public const short FSHARP_RBRACKET= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.FSHARP_RBRACKET;
    internal BracketedFieldValueExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.BRACKETED_FIELD_VALUE_EXPRESSION; }
    }
    public override void Accept(JetBrains.ReSharper.Psi.FSharp.ElementVisitor visitor) {
      visitor.VisitBracketedFieldValueExpression(this);
    }
    ...
    public override TReturn Accept<TContext, TReturn>(JetBrains.ReSharper.Psi.FSharp.TreeNodeVisitor<TContext, TReturn> visitor, TContext context) {
      return visitor.VisitBracketedFieldValueExpressionNode(this, context);
    }
    ...
    public override short GetChildRole (JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.TreeElement child) {
      ...
      if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_LBRACKET_OP) {
        if (current == child) return FSHARP_LBRACKET;
        current = GetNextFilteredChild(current);
        if (current == null) return 0;
      } else return 0;
      if (TokenBitsets.ElementBitset_0[current.NodeType]) {
      ...
      if (current.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_RBRACKET_OP) {
        if (current == child) return FSHARP_RBRACKET;
        current = GetNextFilteredChild(current);
        if (current == null) return 0;
      } else return 0;
      return 0;
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression SetRightOperand (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_LBRACKET_OP) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          }
    ...
    JetBrains.ReSharper.Psi.FSharp.IBracketedFieldValueExpressionNode JetBrains.ReSharper.Psi.FSharp.IBracketedFieldValueExpression.ToTreeNode() { return this; }
    ...
    public override string ToString() {
      return "IBracketedFieldValueExpression";
    }
  }
}

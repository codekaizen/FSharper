...
namespace JetBrains.ReSharper.Psi.FSharp.Impl.Tree {
  internal partial class ArrayExpression : ExpressionBase, JetBrains.ReSharper.Psi.FSharp.IArrayExpressionNode, JetBrains.ReSharper.Psi.FSharp.IArrayExpression {
    ...
    public const short FSAHRP_RBRACKET= JetBrains.ReSharper.Psi.FSharp.Impl.Tree.FSharpChildRole.LAST + 3;
    internal ArrayExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ElementType.ARRAY_EXPRESSION; }
    }
    ...
    public virtual JetBrains.ReSharper.Psi.FSharp.Tree.IExpression SetExpression (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param)
    {
      using (JetBrains.Application.WriteLockCookie.Create (this.IsPhysical()))
      {
        ...
        if (next == null) {
          ...
          if (next.NodeType == JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TokenType.KEYWORD_LBRACKETOR_OP) {
            current = next;
          } else {
            return (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression)result;
          }
    ...
    JetBrains.ReSharper.Psi.FSharp.IArrayExpressionNode JetBrains.ReSharper.Psi.FSharp.IArrayExpression.ToTreeNode() { return this; }

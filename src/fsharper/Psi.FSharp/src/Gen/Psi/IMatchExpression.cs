...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IMatchExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IMatchExpressionNode ToTreeNode();
  }
}

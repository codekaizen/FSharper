...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface ILazyExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.ILazyExpressionNode ToTreeNode();
  }
}

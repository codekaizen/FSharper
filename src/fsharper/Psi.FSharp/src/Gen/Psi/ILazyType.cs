...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface ILazyType : JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.Tree.ILazyTypeNode ToTreeNode();
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class ExceptionReferenceNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode GetByQualifier (JetBrains.ReSharper.Psi.FSharp.Tree.IModuleReference param) {

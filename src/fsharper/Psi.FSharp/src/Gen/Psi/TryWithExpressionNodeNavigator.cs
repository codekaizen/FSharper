...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class TryWithExpressionNodeNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.ITryWithExpressionNode GetByExpressionNode (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param) {
    ...
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.ITryWithExpressionNode GetByPatternMatchingNode (JetBrains.ReSharper.Psi.FSharp.IPatternMatchingNode param) {
      if (param == null) return null;
      TreeElement current = (TreeElement)param;
      if (current.parent is JetBrains.ReSharper.Psi.FSharp.Impl.Tree.TryWithExpression) {

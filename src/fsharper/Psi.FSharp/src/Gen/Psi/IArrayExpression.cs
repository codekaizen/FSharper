...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IArrayExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IArrayExpressionNode ToTreeNode();
  }
}

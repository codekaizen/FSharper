...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IAssertExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IAssertExpressionNode ToTreeNode();
  }
}

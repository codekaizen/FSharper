...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IUpcastExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IUpcastExpressionNode ToTreeNode();
  }
}

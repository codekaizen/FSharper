...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IAttributeReference : JetBrains.ReSharper.Psi.FSharp.Tree.IFSharpElement {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IAttributeReferenceNode ToTreeNode();
  }
}

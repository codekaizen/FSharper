...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IFieldReference : JetBrains.ReSharper.Psi.FSharp.Tree.IFSharpElement {
    ...
    new JetBrains.ReSharper.Psi.FSharp.Tree.IFieldReferenceNode ToTreeNode();
  }
}

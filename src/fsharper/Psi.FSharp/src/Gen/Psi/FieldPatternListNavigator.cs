...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class FieldPatternListNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IFieldPatternListNode GetByFieldPattern (JetBrains.ReSharper.Psi.FSharp.IFieldPattern param) {

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IDowncastExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IDowncastExpressionNode ToTreeNode();
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface ITypedExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.ITypedExpressionNode ToTreeNode();
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class LetDefinitionNodeNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.Tree.ILetDefinitionNode GetByBindingSchemesNode (JetBrains.ReSharper.Psi.FSharp.IBindingSchemeNode param) {
      ...
      return (JetBrains.ReSharper.Psi.FSharp.Tree.ILetDefinitionNode) current;
    }
  }
}

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class ValueSpecificationNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.Tree.IValueSpecificationNode GetByTypeExpression (JetBrains.ReSharper.Psi.FSharp.Tree.ITypeExpression param) {

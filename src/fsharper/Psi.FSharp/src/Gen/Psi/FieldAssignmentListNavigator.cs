...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class FieldAssignmentListNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IFieldAssignmentListNode GetByFieldAssignment (JetBrains.ReSharper.Psi.FSharp.IFieldAssignment param) {

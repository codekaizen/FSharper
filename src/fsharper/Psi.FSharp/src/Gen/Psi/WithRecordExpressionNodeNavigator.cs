...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class WithRecordExpressionNodeNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IWithRecordExpressionNode GetByExpressionNode (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param) {
    ...
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IWithRecordExpressionNode GetByfieldAssignmentList (JetBrains.ReSharper.Psi.FSharp.IFieldAssignmentListNode param) {
      if (param == null) return null;
      TreeElement current = (TreeElement)param;
      if (current.parent is JetBrains.ReSharper.Psi.FSharp.Impl.Tree.WithRecordExpression) {

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IExceptionReference : JetBrains.ReSharper.Psi.FSharp.Tree.IFSharpElement {
    ...
    new JetBrains.ReSharper.Psi.FSharp.Tree.IExceptionReferenceNode ToTreeNode();
  }
}

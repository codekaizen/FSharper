...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class ExpressionSequenceNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IExpressionSequenceNode GetByExpression1 (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param) {
    ...
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IExpressionSequenceNode GetByExpression2 (JetBrains.ReSharper.Psi.FSharp.Tree.IExpression param) {
      if (param == null) return null;
      TreeElement current = (TreeElement)param;
      if (current.parent is JetBrains.ReSharper.Psi.FSharp.Impl.Tree.ExpressionSequence) {

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public static partial class ArrayExpressionNodeNavigator {
    [JetBrains.Annotations.Pure]
    [JetBrains.Annotations.CanBeNull]
    [JetBrains.Annotations.ContractAnnotation("null <= null")]
    public static JetBrains.ReSharper.Psi.FSharp.IArrayExpressionNode GetByExpressionNode (JetBrains.ReSharper.Psi.FSharp.Tree.IExpressionNode param) {

...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IBracketedExpression : JetBrains.ReSharper.Psi.FSharp.Tree.IExpression {
    ...
    new JetBrains.ReSharper.Psi.FSharp.IBracketedExpressionNode ToTreeNode();
  }
}

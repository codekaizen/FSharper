...
namespace JetBrains.ReSharper.Psi.FSharp {
  public partial interface IConstructorReference : JetBrains.ReSharper.Psi.FSharp.Tree.IPattern {
    ...
    new JetBrains.ReSharper.Psi.FSharp.Tree.IConstructorReferenceNode ToTreeNode();
  }
}
